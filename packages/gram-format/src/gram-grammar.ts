...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Gram$ebnf$1", "symbols": ["Gram$ebnf$1", "Gram$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "EdgeExpression", "symbols": ["Node", "Edge", "EdgeExpression"], "postprocess": ([np,es,ep]) => g.cons({operands:[np,ep], operator:es.direction, id:es.id, labels:es.labels, record:es.record} )},
    {"name": "EdgeExpression", "symbols": ["Node"], "postprocess": id},
    {"name": "Node", "symbols": [{"literal":"("}, "_", "Attributes", {"literal":")"}], "postprocess": ([,,content]) => g.node(content.id, content.labels, content.record)},
    {"name": "Edge", "symbols": [{"literal":"-["}, "_", "Attributes", {"literal":"]->"}], "postprocess": ([,,content]) => ({direction:'right', ...content})},
    {"name": "Edge", "symbols": [{"literal":"-["}, "_", "Attributes", {"literal":"]-"}], "postprocess": ([,,content]) => ({direction:'either', ...content})},
    {"name": "Edge", "symbols": [{"literal":"<-["}, "_", "Attributes", {"literal":"]-"}], "postprocess": ([,,content]) => ({direction:'left', ...content})},
    ...
    {"name": "PathComposition", "symbols": [{"literal":"["}, "_", "Attributes", "_", "PathComposition$ebnf$1", "_", "PathComposition$ebnf$2", "_", {"literal":"]"}], "postprocess": ([,,content,,lhs,,rhs]) => g.cons({operands:[lhs,rhs], id:content.id, labels:content.labels, record:content.record})},
    ...
    {"name": "Attributes", "symbols": ["Attributes$ebnf$1", "_", "Attributes$ebnf$2", "_", "Attributes$ebnf$3"], "postprocess": ([id,,labels,,record]) =>  ( {id, labels, record} )},
    ...
    {"name": "Identity", "symbols": [(lexer.has("hexadecimal") ? {type: "hexadecimal"} : hexadecimal)], "postprocess": text},
    {"name": "Identity", "symbols": [(lexer.has("measurement") ? {type: "measurement"} : measurement)], "postprocess": text},
    {"name": "Identity", "symbols": [(lexer.has("tickedString") ? {type: "tickedString"} : tickedString)], "postprocess": ([t]) => t.text.slice(1,-1)},
    {"name": "Symbol", "symbols": [(lexer.has("symbol") ? {type: "symbol"} : symbol)], "postprocess": text},
    {"name": "Symbol", "symbols": [(lexer.has("tickedString") ? {type: "tickedString"} : tickedString)], "postprocess": ([t]) => t.text.slice(1,-1)},
    ...
    {"name": "Record", "symbols": [{"literal":"{"}, "_", "Property", "Record$ebnf$1", {"literal":"}"}], "postprocess": ([,,p,ps]) =>  g.record([p, ...extractPairs(ps)])},
    {"name": "Property", "symbols": ["Symbol", "_", {"literal":":"}, "_", "Value"], "postprocess": ([k,,,,v]) => g.property(k,v)},
    {"name": "Value", "symbols": ["StringLiteral"], "postprocess": id},
    {"name": "Value", "symbols": ["NumericLiteral"], "postprocess": id},
    {"name": "Value", "symbols": [(lexer.has("boolean") ? {type: "boolean"} : boolean)], "postprocess": (d) => g.boolean(JSON.parse(d[0].value.toLowerCase()))},
    ...
    {"name": "Value", "symbols": [{"literal":"["}, "_", "Value", "Value$ebnf$1", {"literal":"]"}], "postprocess": ([,,v,vs]) => ([v, ...extractArray(vs)])},
    {"name": "StringLiteral", "symbols": [(lexer.has("singleQuotedString") ? {type: "singleQuotedString"} : singleQuotedString)], "postprocess": (d) => g.string(d[0].value)},
    {"name": "StringLiteral", "symbols": [(lexer.has("doubleQuotedString") ? {type: "doubleQuotedString"} : doubleQuotedString)], "postprocess": (d) => g.string(d[0].value)},
    {"name": "StringLiteral", "symbols": [(lexer.has("tickedString") ? {type: "tickedString"} : tickedString)], "postprocess": (d) => g.string(d[0].value)},
    {"name": "StringLiteral", "symbols": [(lexer.has("taggedString") ? {type: "taggedString"} : taggedString)], "postprocess":  (d) => {
          const parts = separateTagFromString(d[0].value);
          return g.tagged(parts.tag, parts.value) 
        }},
    {"name": "NumericLiteral", "symbols": [(lexer.has("integer") ? {type: "integer"} : integer)], "postprocess": (d) => g.integer(d[0].value)},
    {"name": "NumericLiteral", "symbols": [(lexer.has("decimal") ? {type: "decimal"} : decimal)], "postprocess": (d) => g.decimal(d[0].value)},
    {"name": "NumericLiteral", "symbols": [(lexer.has("hexadecimal") ? {type: "hexadecimal"} : hexadecimal)], "postprocess": (d) => g.hexadecimal(d[0].value)},
    {"name": "NumericLiteral", "symbols": [(lexer.has("octal") ? {type: "octal"} : octal)], "postprocess": (d) => g.octal(d[0].value)},
    {"name": "NumericLiteral", "symbols": [(lexer.has("measurement") ? {type: "measurement"} : measurement)], "postprocess":  (d) => {
