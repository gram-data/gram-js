...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "PathPattern", "symbols": [{"literal":"["}, "_", "ContentSpecification", "_", "PathPattern$ebnf$1", {"literal":"]"}], "postprocess": ([,,content,,ep]) => g.path(ep||[], content.id, content.labels, content.record)},
    {"name": "PathPattern", "symbols": ["EdgePattern"], "postprocess": ([ep]) => g.path(ep)},
    {"name": "NodePattern", "symbols": [{"literal":"("}, "_", "ContentSpecification", {"literal":")"}], "postprocess": ([,,content]) => g.node(content.id, content.labels, content.record)},
    {"name": "EdgePattern", "symbols": ["NodePattern", "EdgeSpecification", "EdgePattern"], "postprocess": ([np,es,ep]) => g.edge([np,ep], es.direction, es.id, es.labels, es.record )},
    {"name": "EdgePattern", "symbols": ["NodePattern"], "postprocess": id},
    {"name": "EdgeSpecification", "symbols": [{"literal":"-["}, "_", "ContentSpecification", {"literal":"]->"}], "postprocess": ([,,content]) => ({direction:'right', ...content})},
    {"name": "EdgeSpecification", "symbols": [{"literal":"-["}, "_", "ContentSpecification", {"literal":"]-"}], "postprocess": ([,,content]) => ({direction:'none', ...content})},
    {"name": "EdgeSpecification", "symbols": [{"literal":"<-["}, "_", "ContentSpecification", {"literal":"]-"}], "postprocess": ([,,content]) => ({direction:'left', ...content})},
    ...
    {"name": "ContentSpecification", "symbols": ["ContentSpecification$ebnf$1", "_", "ContentSpecification$ebnf$2", "_", "ContentSpecification$ebnf$3"], "postprocess": ([id,,labels,,record]) =>  ( {id, labels, record} )},
    ...
    {"name": "SymbolicName", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": text},
    {"name": "SymbolicName", "symbols": [(lexer.has("tickedString") ? {type: "tickedString"} : tickedString)], "postprocess": ([t]) => t.text.slice(1,-1)},
    ...
    {"name": "Property", "symbols": ["Key", "_", {"literal":":"}, "_", "Value"], "postprocess": ([k,,,,v]) => g.property(k,v)},
    ...
    {"name": "NumericLiteral", "symbols": [(lexer.has("unit") ? {type: "unit"} : unit)], "postprocess":  (d) => {
    ...
    {"name": "EOL$ebnf$1$subexpression$1", "symbols": [(lexer.has("lineComment") ? {type: "lineComment"} : lineComment), /[\n]/]},
    ...
    {"name": "Comment", "symbols": [(lexer.has("lineComment") ? {type: "lineComment"} : lineComment), "Comment$ebnf$1"], "postprocess": empty}
  ],
  ParserStart: "Gram",
};
