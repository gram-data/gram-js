...
describe('base2 conversions', () => {
  ...
  it('should convert MAX_SAFE_INTEGER', () => {
    expect(integerToBase(alphabets.base2, Number.MAX_SAFE_INTEGER)).toEqual(
  ...
  it('should convert MAX_SAFE_INTEGER literal 9007199254740991', () => {
    expect(integerLiteralToBase(alphabets.base2, '9007199254740991')).toEqual(
      '11111111111111111111111111111111111111111111111111111'
    );
  });
  it.each`
