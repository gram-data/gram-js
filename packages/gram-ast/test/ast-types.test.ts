...
describe('gram ast boolean literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isBooleanLiteral(literal))
...
describe('gram ast string literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isStringLiteral(literal))
...
describe('gram ast tagged literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isTaggedLiteral(literal))
...
describe('gram ast integer literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isIntegerLiteral(literal))
...
describe('gram ast measurement literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isMeasurementLiteral(literal))
...
describe('gram ast decimal literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isDecimalLiteral(literal))
...
describe('gram ast hexadecimal literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isHexadecimalLiteral(literal))
...
describe('gram ast octal literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isOctalLiteral(literal))
...
describe('gram ast tagged date literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isDateLiteral(literal))
...
describe('gram ast tagged geospatial literals', () => {
  ...
  it('has a type guard', () => {
    ...
    if (gramTypes.isGeospatialLiteral(literal))
      expect(literal.tag === 'geo').toBeTruthy();
    else fail('Denied by typeguard');
  });
});
